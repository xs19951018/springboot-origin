...
import static com.baomidou.mybatisplus.core.toolkit.StringUtils.EMPTY;
...
public final class DateUtils {
     ...
     * @param date  时间字符串
     * @param format    时间格式
     * @param addNum    增加的天数，减少即为负数
     * @return
     */
    public static String dateAddDaily(String date, final DateFormat format, int addNum) {
        return millis2String(
                string2Millis(date, DateUtils.yyyyMMdd.get()) + addNum * 24 * 60 * 60 * 1000, DateUtils.yyyyMMdd.get()
        );
    }
